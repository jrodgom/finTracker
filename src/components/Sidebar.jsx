...
import { FiHome, FiPlusCircle, FiTarget, FiBarChart2, FiLogOut } from 'react-icons/fi';
  ...
  return (
    <aside className="home-sidebar glass">
      ...
      <nav className="sidebar-nav">
        ...
        <button className={`nav-item ${isActive('/nuevo')}`} onClick={() => navigate('/nuevo')}>
          <FiPlusCircle className="nav-icon" /><span>Nuevo Movimiento</span>
        </button>
        <button className={`nav-item ${isActive('/presupuestos')}`} onClick={() => navigate('/nuevo-gasto-plazo')}>
          <FiTarget className="nav-icon" /><span>Gastos a Plazos</span>
        </button>
        <button className={`nav-item ${isActive('/clientes')}`} onClick={() => navigate('/clientes')}>
          <FiBarChart2 className="nav-icon" /><span>Clientes</span>
        </button>
